...
2. To start ReactJS run `npm run dev` inside 'client' folder. On success you'd see the following message:

Local:   http://localhost:5173/ <br/>
Network: use --host to expose <br/>
press h + enter to show help <br/>

3. To start backe-end, please run `npm start` inside 'server' folder. On success you'd see the following:
